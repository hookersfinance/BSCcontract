...
/**
*For more info visit hookers.finance
*Telegram: https://t.me/hookersfinance
*/
...
import "./Ownable.sol";
import "./Address.sol";
import "./HOOKERSMetaData.sol";

contract HOOKERS is Ownable, HOOKERSMetaData {
	...
	/**
	 *@dev The transaction fee users will incur upon selling the token. 4 percent of the principal.
	 */
	...
	address public immutable HOOKERSFund;

	constructor(address routerAddress, address HOOKERSFundAddress) {
		/**
		...
		HOOKERSFund = HOOKERSFundAddress;

		_isExcludedFromFees[owner()] = true;
		_isExcludedFromFees[address(this)] = true;
		_isExcludedFromFees[HOOKERSFundAddress] = true;
	...
	function _transferToken(
		...
		_reflectionBalance[HOOKERSFund] = _reflectionBalance[HOOKERSFund] + rTax;
